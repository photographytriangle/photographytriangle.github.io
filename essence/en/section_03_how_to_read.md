## SECTION 3. HOW TO READ THIS ESSENCE
...
1. The user's vocabulary is identified according to Section 8 (one of three entry points).
2. The question is matched to one of the layers per Section 7 (most often the first, sometimes the second, rarely the third).
3. The glossary (Section 14) is consulted for key terms used by the user or applicable to the response.
...
### Prioritization rules in case of conflict.
...
### When deviation from this essence is appropriate.
...
### On direct questions about this essence.
